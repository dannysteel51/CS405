...
TEST_F(CollectionTest, MaxSizeGreaterThanOrEqualToEntries)
{
...
TEST_F(CollectionTest, CapacityGreaterThanOrEqualToEntries)
{
	collection->push_back(0);
	collection->push_back(1);
	collection->push_back(5);
...
TEST_F(CollectionTest, ReserveIncreasesCapacityNotSize)
{
	...
	EXPECT_GT(collection->capacity(), oldCapacity);
}
...
TEST_F(CollectionTest, CanAddToVector)
{
	collection->push_back(1);
	collection->push_back(2);
